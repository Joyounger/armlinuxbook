...
static QString mydrawtext[10];

EightMainWindow::EightMainWindow(QWidget *parent, Qt::WFlags fl)
  : QMainWindow( parent, fl )
{
    ...
    setWindowTitle(tr("Eight Pieces"));
    ...
    QSoftMenuBar::setLabel(this, Qt::Key_Select, QSoftMenuBar::NoLabel);
	 ...
	 mydrawtext[0].append("UPC");
	 mydrawtext[1].append("China");
	 mydrawtext[2].append("University");
	 mydrawtext[3].append("of");
	 mydrawtext[4].append("Petroleum");
	 mydrawtext[5].append("Computer&");
	 mydrawtext[6].append("Communication");
	 mydrawtext[7].append("Institution");
	 mydrawtext[8].append("Zheng");
	 mydrawtext[9].append("Pengfei");
	
   
}

void EightMainWindow::showNumber()
{
    actionShowNum->setChecked( bGameWon ? false : !bShowNumber );
    bShowNumber = bGameWon ? false : actionShowNum->isChecked();
}

void EightMainWindow::updateMenu( bool useImage )
{
...
void PiecesDelegate::paint(QPainter *p, const QStyleOptionViewItem &o, const QModelIndex &i) const
{
    ...
    // draw number
    p->setPen(Qt::black);
    p->drawText(o.rect.x(), o.rect.y(), x2, y2, Qt::AlignHCenter | Qt::AlignVCenter, mydrawtext[number]);
}
...
{
    bGameWon = true;
    QMessageBox::information(this, tr("Eight Pieces"),
