...
#ifdef __cplusplus
SOAP_SOURCE_STAMP("@(#) stdsoap2.cpp ver 2.7.9f 2007-04-27 12:00:00 GMT")
extern "C" {
#else
SOAP_SOURCE_STAMP("@(#) stdsoap2.c ver 2.7.9f 2007-04-27 12:00:00 GMT")
#endif
...
{ char header[SOAP_HDRLEN], *s;
  ...
  */
  if (((k > 200 && k <= 299) || k == 400 || k == 500) && (soap->length > 0 || (soap->mode & SOAP_IO) == SOAP_IO_CHUNK))
    return SOAP_OK;
